        ...
        for attempt in range(retries):
            ...
            try:
                ...
                if e.code == 429 and attempt < retries - 1:
                    ...
                    print(f"   ⚠️  {model} rate-limited, switching to {GEMINI_FALLBACK}...", flush=True)
                    break
                else:
                    raise
    raise RuntimeError("Gemini API rate-limited on both models. Try again later.")
        ...
        for attempt in range(retries):
            ...
            try:
                ...
                if e.code == 429 and attempt < retries - 1:
                    ...
                    raise
    raise RuntimeError("API rate-limited on both models. Try again later.")
...
def main():
    ...
    try:
        ...
        script = call_ai(prompt, provider, api_key)
